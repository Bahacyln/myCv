...
function skillsBox(array=[]) {
  ...
  if(array[0]!=undefined){
    return (
          <div className="flex items-center w-[700px] min-h-80 bg-white shadow-[0px_0px_25px_5px_rgba(134,134,134,0.391)] justify-around">
                      ...
                      <div className="flex flex-row flex-wrap">
                        {item.items.map((elem,ind)=>(
                          <div key={ind} className='w-1/2 p-2 flex gap-1 items-center'>
                            <BiSolidSquareRounded className="iconColor" />
